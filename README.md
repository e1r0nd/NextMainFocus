...
##Annotation
Started in *November 2014*. One page app for preservation the focus on the main problems right now. MEAN application with Angular Material. Responsive design, mobile first approach, localization, localstorage, unit testing (Mocha, Chai, Sinon), Grunt, Bower. http://e1r0nd.github.io/nextmainfocus
